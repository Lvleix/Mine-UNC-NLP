...
class cla_veri_train():
    def __init__(self, train_data, wikis, embedding_class, doc_retr_model, sen_sele_model, model_path, epoches=1, batch_size=32, embedding_size=50, mode="demo"):
        ...
        if mode in ["demo"]:
            ...
            self.NSMN = SemanticNet.NSMN(embedding_size, 40, 40, 30, hidden_dim=128, lstm_layers=3, classify_num=3)
        self.dataset1 = []
        self.dataset2 = []
        self.labelset = []
        ...
        del self.doc_retr_class
        del self.sen_sele_class
